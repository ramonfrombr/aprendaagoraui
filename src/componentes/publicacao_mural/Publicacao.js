        ...
        <Container>
            <Wrap>
                <Cabecalho>
                    <CabecalhoEsquerda>
                        <ImagemPerfil
                            src={Usuarios.filter((usuario) => usuario.id===publicacao.usuario_id)[0].imagem_perfil}
                        />

                        <NomeUsuario>{Usuarios.filter((usuario) => usuario.id===publicacao.usuario_id)[0].nome_usuario}</NomeUsuario>
